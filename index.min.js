...
main = function() {
  ...
  setGameOver = function() {
    ...
    gameOverText.setText("NÃO deu NÃO\n\nBIRL SCORE\n\n" + hiscore);
  ...
  preload = function() {
    ...
    assets = {
      ...
      audio: {
        ...
        its37Anos: ["assets/37-anos.mp3"],
        aquiEhBodyBuilder: ["assets/aqui-e-body-builder.mp3"],
      }
    };
  ...
  create = function() {
    ...
    its37AnosSnd = game.add.audio("its37Anos");
    aquiEhBodyBuilderSnd = game.add.audio("aquiEhBodyBuilder");
  ...
  reset = function() {
    ...
    gameOver = false;
    score = 0;
    scoreText.setText("Flappy BIRL");
    instText.setText("TOUCH TO BIRL\nbird WINGS");
